...
class HeadComponent extends HTMLElement {
  ...
  render() {
    ...
    <!-- Favicons -->
    <link rel="icon" href="${href}assets/icons/favicon.svg">
    <link rel="mask-icon" href="${href}assets/icons/mask-icon.svg" color="#000000">
    <link rel="apple-touch-icon" href="${href}assets/icons/apple-touch-icon.png">
